  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft hover:shadow-glow font-medium",
        elegant: "bg-sage text-sage-foreground hover:bg-sage/90 shadow-soft hover:shadow-elegant font-medium",
        cta: "accent-gradient text-primary font-semibold shadow-soft hover:shadow-glow hover:scale-105 transition-spring",
      },
      size: {
